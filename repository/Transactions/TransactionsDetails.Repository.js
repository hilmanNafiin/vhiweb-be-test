...
class TransactionsDetailsRepository {
  async getOneRepository(params) {
    try {
      const response = await _.from("transactionsdetails")
        .where(params)
        .first();
  ...
  async getOneProductRepository(params) {
    try {
      const response = await _.from("transactionsdetails")
        .where(params)
  ...
  async createRepository(params) {
    try {
      const result = await _.insert(params).into("transactionsdetails");
  ...
  async updateRepository(params, condition) {
    try {
      const result = await _.from("transactionsdetails")
        .where(condition)
        .update(params);
...
module.exports = new TransactionsDetailsRepository();
